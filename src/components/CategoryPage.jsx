...
const CategoryPage = () => {
    ...
    useEffect(() => {
        const getCategoryProjects = async () => {
            try {
                const response = await axios.get(`http://127.0.0.1:8000/api/projects/category/${categoryId}/`);
    ...
    if (loading) return <p className="text-center text-lg font-bold">Loading Projects...</p>;
